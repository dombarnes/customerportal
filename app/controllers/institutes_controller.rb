class InstitutesController < ApplicationController
  ...
  def show
    @reseller = Reseller.where(:reseller_id => :id).name
  end
  ...
  private
    ...
    def institute_params
      params.require(:institute).permit(:name, :subdomain, :address, :contact, :contact_tel, :admin_contact, :admin_contact_tel, :subscription_type, :subscription_start_date, :subscription_end_date, :reseller_id, :reseller_contact)
    end
end
